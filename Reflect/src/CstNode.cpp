...
typedef const Luau::CstNode* (*CstNodeFactoryFn)(Luau::Allocator& alloc);
...
struct CstNodeClassInfo
{
    ...
    CstNodeFactoryFn factory = nullptr;
};
...
{
    for (size_t i = 0; i < s_cstClassTable.size(); i++)
    {
        if (s_cstClassTable[i].kind && kind == s_cstClassTable[i].kind && s_cstClassTable[i].factory)
            return s_cstClassTable[i].factory(alloc);
    }
    return nullptr;
}
...
#define LUAU_REFLECT_CST_NODES(NODE, NODE_EMPTY) \
    NODE(CstAttr, "CstAttr", \
        LUAU_CST_DEFAULT(false) \
        LUAU_CST_FIELD_RO(HasAt, hasAt)) \
    NODE(CstParametrizedAttr, "CstParametrizedAttr", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}) \
    ...
    NODE(CstExprConstantString, "CstExprConstantString", \
        LUAU_CST_DEFAULT(Luau::AstArray<char>{nullptr, 0}, Luau::CstExprConstantString::QuoteStyle::QuotedSingle, 0) \
    ...
    NODE(CstExprIndexExpr, "CstExprIndexExpr", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing()) \
    ...
    NODE(CstExprTable, "CstExprTable", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::CstExprTable::Item>{nullptr, 0}) \
    ...
    NODE(CstExprIfElse, "CstExprIfElse", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing(), false) \
    ...
    NODE(CstExprInterpString, "CstExprInterpString", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::AstArray<char>>{nullptr, 0}, Luau::AstArray<Luau::Position>{nullptr, 0}) \
    ...
    NODE_EMPTY(CstExprExplicitTypeInstantiation, "CstExprExplicitTypeInstantiation", \
        LUAU_CST_DEFAULT(Luau::CstTypeInstantiation{})) \
    ...
    NODE(CstStatReturn, "CstStatReturn", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::Position>{nullptr, 0}) \
        LUAU_CST_FIELD_RO(CommaPositions, commaPositions)) \
    NODE(CstStatLocal, "CstStatLocal", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::AstArray<Luau::Position>{nullptr, 0}) \
    ...
    NODE(CstStatFor, "CstStatFor", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing(), Luau::Position::missing(), Luau::Position::missing()) \
    ...
    NODE(CstStatAssign, "CstStatAssign", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}) \
        LUAU_CST_FIELD_RO(VarsCommaPositions, varsCommaPositions) \
        LUAU_CST_FIELD_RO(EqualsPosition, equalsPosition) \
        LUAU_CST_FIELD_RO(ValuesCommaPositions, valuesCommaPositions)) \
    ...
    NODE(CstStatTypeAlias, "CstStatTypeAlias", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::Position::missing(), Luau::Position::missing()) \
    ...
    NODE(CstTypeReference, "CstTypeReference", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::Position::missing()) \
    ...
    NODE(CstTypeTable, "CstTypeTable", \
        LUAU_CST_DEFAULT(Luau::AstArray<Luau::CstTypeTable::Item>{nullptr, 0}, false) \
        LUAU_CST_FIELD_RO(IsArray, isArray)) \
    NODE(CstTypeFunction, "CstTypeFunction", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::Position::missing(), Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::AstArray<Luau::Position>{nullptr, 0}, Luau::Position::missing(), Luau::Position::missing()) \
        LUAU_CST_FIELD_RO(OpenGenericsPosition, openGenericsPosition) \
        LUAU_CST_FIELD_RO(GenericsCommaPositions, genericsCommaPositions) \
        LUAU_CST_FIELD_RO(CloseGenericsPosition, closeGenericsPosition) \
    ...
    NODE(CstTypeUnion, "CstTypeUnion", \
        LUAU_CST_DEFAULT(Luau::Position::missing(), Luau::AstArray<Luau::Position>{nullptr, 0}) \
...
/* default ctor */
#define LUAU_CST_DEFAULT(...) return alloc.alloc<CurrentCstNode>(__VA_ARGS__);
#define LUAU_CST_FIELD_RO(atomGet, memberExpr)

#define LUAU_GENERATE_CST_FACTORY(Class, KindStr, Fields) \
    static const ::Luau::CstNode* createDefault##Class(::Luau::Allocator& alloc) \
    { \
        using CurrentCstNode = ::Luau::Class; \
        Fields \
        return nullptr; \
    }
#define LUAU_GENERATE_CST_FACTORY_EMPTY(Class, KindStr, Fields) \
    static const ::Luau::CstNode* createDefault##Class(::Luau::Allocator& alloc) \
    { \
        using CurrentCstNode = ::Luau::Class; \
        Fields \
...
LUAU_REFLECT_CST_NODES(LUAU_GENERATE_CST_FACTORY, LUAU_GENERATE_CST_FACTORY_EMPTY)

#undef LUAU_GENERATE_CST_FACTORY
#undef LUAU_GENERATE_CST_FACTORY_EMPTY
#undef LUAU_NODE_DEFAULT
#undef LUAU_CST_DEFAULT
#undef LUAU_CST_FIELD_RO

/* methods */
#define LUAU_CST_DEFAULT(...)
...
#define LUAU_GENERATE_CST_HANDLER_EMPTY(Class, KindStr, Fields)
...
#define LUAU_GENERATE_CST_PROP_COLLECTOR_EMPTY(Class, KindStr, Fields)
...
#define LUAU_REGISTER_CST_NODE(Class, KindStr, Fields) \
        registerCstNodeClass<::Luau::Class>(KindStr, handle##Class##Methods, collect##Class##CstProps, createDefault##Class);
#define LUAU_REGISTER_CST_NODE_EMPTY(Class, KindStr, Fields) \
        registerCstNodeClass<::Luau::Class>(KindStr, nullptr, nullptr, createDefault##Class);
...
LUAU_REFLECT_DEFINE_EQ(cstNodeEq, TagCstNode, checkCstNode, a.node == b.node)
